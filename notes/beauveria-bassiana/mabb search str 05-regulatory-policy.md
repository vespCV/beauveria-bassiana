...
Regulatory and delivery OR-groups updated 2026-08-07 from Consensus `05` pass (EFSA, 1107/2009, emergency authorisation, autodissemination).
...
**Dimensions** (publications + patents + policy documents filter)
