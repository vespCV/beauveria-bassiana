...
## Shared (append after each subquestion ask)

```
Return:
1. A ranked list of about 8–15 most important papers (title, year, DOI or PMID when available, one sentence on why it matters for this subquestion).
