...
Spasova, Mariya, Emiliya Chervenkova, Atanaska Stoeva, Mariana Petkova, en Olya Stoilova. “Biopolymer-Based Formulations of Beauveria Bassiana for Biological Control of the Cabbage Whitefly (Aleyrodes Proletella)”. _Pathogens_ 15, nr. 5 (2026): 524. [https://doi.org/10.3390/pathogens15050524](https://doi.org/10.3390/pathogens15050524).
...
Whiteflies, including Aleyrodes proletella," Yellow
	Highlight [Page	](zotero://open-pdf/library/items/R9AFN26B?page=&annotation=PS943H25)

its field performance is often constrained by environmental sensitivity and limited formulation stability." Yellow
	Highlight [Page	](zotero://open-pdf/library/items/R9AFN26B?page=&annotation=7E74VTQQ)

biopolymer-based suspensions incorporating" Yellow
	Highlight [Page	](zotero://open-pdf/library/items/R9AFN26B?page=&annotation=5GD6QYVV)

chitooligosaccharide (COS) and 2-hydroxyethyl cellulose (HEC) as biodegradable carriers." Yellow
	Highlight [Page	](zotero://open-pdf/library/items/R9AFN26B?page=&annotation=27F57PLP)

These results demonstrate that biopolymer-based formulations, particularly COSbased systems, preserve fungal virulence and represent promising biodegradable delivery platforms for sustainable whitefly management" Yellow
	Highlight [Page	](zotero://open-pdf/library/items/R9AFN26B?page=&annotation=2DYAZSPC)
