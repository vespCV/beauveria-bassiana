...
Clifton, Eric H., Ann E. Hajek, Nina E. Jenkins, Richard T. Roush, John P. Rost, en David J. Biddinger. “Applications of Beauveria Bassiana (Hypocreales: Cordycipitaceae) to Control Populations of Spotted Lanternfly (Hemiptera: Fulgoridae), in Semi-Natural Landscapes and on Grapevines”. _Environmental Entomology_ 49, nr. 4 (2020): 854-64. [https://doi.org/10.1093/ee/nvaa064](https://doi.org/10.1093/ee/nvaa064).
...
Spotted lanternfly, Lycorma delicatula" Yellow
	Highlight [Page	](zotero://open-pdf/library/items/Z2YSAQRN?page=&annotation=7AD4PKPN)

two fungal entomopathogens (Beauveria bassiana and Batkoa major)" Yellow
	Highlight [Page	](zotero://open-pdf/library/items/Z2YSAQRN?page=&annotation=SPYX48X9)

Beauveria bassiana spores remained viable on foliage for 5–7 d after spraying." Yellow
	Highlight [Page	](zotero://open-pdf/library/items/Z2YSAQRN?page=&annotation=RDQABYBJ)

formulated as BoteGHA and Aprehend" Yellow
	Highlight [Page	](zotero://open-pdf/library/items/Z2YSAQRN?page=&annotation=7SZTKA89)

All the mycoinsecticides killed ≥90% of adults after 9 d using direct applications." Yellow
	Highlight [Page	](zotero://open-pdf/library/items/Z2YSAQRN?page=&annotation=H8BRZ3IJ)

The observed persistence of B. bassiana CFUs on foliage (Fig. 1) corresponds with BoteGHA’s label recommendations to reapply when needed every 5 to 7 d." Yellow
	Highlight [Page	8](zotero://open-pdf/library/items/Z2YSAQRN?page=8&annotation=9DYIQJT9)

The immediate mortality from direct applications of Aprehend was caused by its oil-based formulation and not from B. bassiana infection" Yellow
	Highlight [Page	10](zotero://open-pdf/library/items/Z2YSAQRN?page=10&annotation=JGFT8957)

New York State Department of Agriculture and Markets" Yellow
	Highlight [Page	10](zotero://open-pdf/library/items/Z2YSAQRN?page=10&annotation=6YNB62VC)

Pennsylvania Department of Agriculture—Agricultural Resource Center," Yellow
	Highlight [Page	10](zotero://open-pdf/library/items/Z2YSAQRN?page=10&annotation=G9FNE6GX)

ertis USA) for providing BoteGHA and PFR-97 products for trials." Yellow
	Highlight [Page	10](zotero://open-pdf/library/items/Z2YSAQRN?page=10&annotation=4VM6T5JE)
