## Larval Mortality and Ovipositional Preference in <i>Aedes albopictus</i> (Diptera: Culicidae) Induced by the Entomopathogenic Fungus <i>Beauveria bassiana</i> (Hypocreales: Cordycipitaceae)

### Formatted Bibliography

Kirsch, John M., en Jia-Wei Tay. “Larval Mortality and Ovipositional Preference in _Aedes Albopictus_ (Diptera: Culicidae) Induced by the Entomopathogenic Fungus _Beauveria Bassiana_ (Hypocreales: Cordycipitaceae)”. _Journal of Medical Entomology_ 59, nr. 5 (2022): 1687-93. [https://doi.org/10.1093/jme/tjac084](https://doi.org/10.1093/jme/tjac084).
...
five concentrations of B. bassiana using Mycotrol ESO" Yellow
	Highlight [Page	](zotero://open-pdf/library/items/LXC4BRCU?page=&annotation=V6R92E2A)

B. bassiana-infused ovitraps can be used for mosquito population" Yellow
	Highlight [Page	](zotero://open-pdf/library/items/LXC4BRCU?page=&annotation=5GVS4ASI)

Beauveria bassiana strain GHA was purchased in the form of Mycotrol ESO" Yellow
	Highlight [Page	2](zotero://open-pdf/library/items/LXC4BRCU?page=2&annotation=68ULZFN3)

fungi degrade quickly in UV light," Yellow
	Highlight [Page	6](zotero://open-pdf/library/items/LXC4BRCU?page=6&annotation=IX6PPK7I)

The current study shows that UV degradation can be minimized with attention to trap placement, aided by temperatures that allow for fungus survival." Yellow
	Highlight [Page	6](zotero://open-pdf/library/items/LXC4BRCU?page=6&annotation=BXNL24YT)
