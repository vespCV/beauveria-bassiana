...
Reddy, Gadi V. P., en Frank B. Antwi. “Toxicity of Natural Insecticides on the Larvae of Wheat Head Armyworm, Dargida Diffusa (Lepidoptera: Noctuidae)”. _Environmental Toxicology and Pharmacology_ 42 (maart 2016): 156-62. [https://doi.org/10.1016/j.etap.2016.01.014](https://doi.org/10.1016/j.etap.2016.01.014).
...
- cite_label: Reddy2016
- evidence: abstract
- host_pest: [to be verified]
- strain_product: Mycotrol; GHA; Beauveria bassiana GHA
- delivery_mode: unclear
- mortality: 100% mortality
- lt_lc: [to be verified]
- colony_nest_effects: [to be verified]
- notes: Reddy GV, 2016, o.a.; abstract-only extraction


wheat head armyworm, Dargida (previously Faronta) diffusa" Yellow
	Highlight [Page	](zotero://open-pdf/library/items/4BM6CY2Y?page=&annotation=YDJ3HQIE)

Entrust® WP (spinosad 80%), Mycotrol® ESO (Beauveria bassiana GHA), Aza-Direct® (azadirachtin), Met52® EC (Metarhizium brunneum F52), Xpectro® OD (Beauveria bassiana GHA + pyrethrins), and Xpulse® OD (Beauveria bassiana GHA + azadirachtin)." Yellow
	Highlight [Page	](zotero://open-pdf/library/items/4BM6CY2Y?page=&annotation=D8IBTINQ)
