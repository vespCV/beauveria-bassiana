...
Kanzaki, Natsumi, Shun’ichi Makino, Hajime Kosaka, Katsuhiko Sayama, Keiko Hamaguchi, en Shinji Narayama. “Nematode and Strepsipteran Parasitism in Bait-Trapped and Hand-Collected Hornets (Hymenoptera, Vespidae, Vespa)”. _Insects_ 14, nr. 4 (2023): 398. [https://doi.org/10.3390/insects14040398](https://doi.org/10.3390/insects14040398).
...
Parasites sometimes manipulate host behavior to effectively utilize their hosts." Yellow
	Highlight [Page	](zotero://open-pdf/library/items/LMQBY2CP?page=&annotation=Z6ABBESP)

Sphaerularia vespae, and two species of parasitic insects, Xenos spp.," Yellow
	Highlight [Page	](zotero://open-pdf/library/items/LMQBY2CP?page=&annotation=9WI5EWVR)

Because the bait trap attracts feeding (not foraging for colony) individuals, the parasitism manipulates the host to visit a feeding site, and the result is in good accordance with previous observations; i.e., parasitized hosts frequently visit and stay at feeding sites instead of foraging and reproducing." Yellow
	Highlight [Page	](zotero://open-pdf/library/items/LMQBY2CP?page=&annotation=5ASFAJZF)

V. mandarinia, V. analis, V. simillima, and V. ducalis" Yellow
	Highlight [Page	4](zotero://open-pdf/library/items/LMQBY2CP?page=4&annotation=ZTFHFY38)

Grants-in-Aid for Scientific Research" Yellow
	Highlight [Page	13](zotero://open-pdf/library/items/LMQBY2CP?page=13&annotation=567EQVWQ)

The Japan Society for the Promotion of Science" Yellow
	Highlight [Page	13](zotero://open-pdf/library/items/LMQBY2CP?page=13&annotation=E5SYU3Q9)

no conflict of interest." Yellow
	Highlight [Page	13](zotero://open-pdf/library/items/LMQBY2CP?page=13&annotation=7TAYHBIQ)
