...
PubMed is intentionally broader than Google Scholar (no trap/bait AND): many horizontal-transmission abstracts omit those words. Narrow at Phase 1.

Behaviour and synonym OR-groups updated 2026-08-07 from Consensus `03` pass (autoinoculation, nest hygiene, social insect, autocontamination, disseminator, eusocial taxa; formulation terms left on `02c`).
